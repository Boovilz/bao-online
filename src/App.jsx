...
function normalizePlayer(saved = {}) { return { ...DEFAULT_PLAYER, ...saved, inventory: { ...DEFAULT_PLAYER.inventory, ...(saved.inventory || {}) }, quest: { ...DEFAULT_PLAYER.quest, ...(saved.quest || {}) }, learning: { ...DEFAULT_PLAYER.learning, ...(saved.learning || {}) }, badges: Array.isArray(saved.badges) ? saved.badges : [] }; }
...
export default function App() {
  ...
  return <main className="app">
    ...
    <footer className="help">Phase 7 เพิ่มศูนย์ควบคุมครู · ข้อมูล Dashboard ยังเป็นข้อมูลจำลองในเครื่อง</footer>
